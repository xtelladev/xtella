Contributing to xtella Core
============================

The xtella Core project operates an open contributor model where anyone is
...
The following applies to code changes to the xtella Core project, and is not to be
confused with overall xtella Network Protocol consensus changes.

Whether a pull request is merged into xtella Core rests with the project merge
...
Patches that change xtella consensus rules are considerably more involved than
...
Where a patch set proposes to change the xtella consensus, it must have been
...
The project leader is the release manager for each xtella Core release.
