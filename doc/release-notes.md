xtella Core version 2.3.0 is now available from:

  <https://github.com/xtella-project/xtella/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/xtella-project/xtella/issues>

Compatibility
==============

xtella Core is extensively tested on multiple operating systems using
...
xtella Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) xtella MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode xtella address
...
xtella Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for xtella (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with xtella (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/xtella-project-translations/).
