...
In order to support loading of multiple wallets in xtella-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xtella.cpp.
...
Changes to xtella.cpp
----------------------
xtella.cpp is the entry point into xtella-qt, and as such, will require some minor modifications to provide hooks for
