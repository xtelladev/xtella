...
This mechanism has been integrated into Bitcore-Node-xtella which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/xtella-Project/insight-api-xtella#web-socket-api](https://github.com/xtella-Project/insight-api-xtella#web-socket-api) 
* API: [https://github.com/xtella-Project/insight-api-xtella#swifttx-transactions](https://github.com/xtella-Project/insight-api-xtella#swifttx-transactions) 
...
By default, the xtella Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the xtella Core daemon:
