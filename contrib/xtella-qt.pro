...
RESOURCES += src/qt/xtella.qrc src/qt/xtella_locale.qrc

TRANSLATIONS += src/qt/locale/xtella_bg.ts \
                src/qt/locale/xtella_de.ts \
                src/qt/locale/xtella_en.ts \
                src/qt/locale/xtella_es.ts \
                src/qt/locale/xtella_fi.ts \
                src/qt/locale/xtella_fr.ts \
                src/qt/locale/xtella_it.ts \
                src/qt/locale/xtella_ja.ts \
                src/qt/locale/xtella_pl.ts \
                src/qt/locale/xtella_pt.ts \
                src/qt/locale/xtella_ru.ts \
                src/qt/locale/xtella_sk.ts \
                src/qt/locale/xtella_sv.ts \
                src/qt/locale/xtella_vi.ts \
                src/qt/locale/xtella_zh_CN.ts \
                src/qt/locale/xtella_zh_TW.ts
