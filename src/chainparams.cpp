...
static Checkpoints::MapCheckpoints mapCheckpoints =
      boost::assign::map_list_of(0, uint256("0x10452f6ee15188c8777bd32a03d9cc2be3f03ae133cf8bb5caaf7c95fcab86f6"))
	    (5, uint256("0x0000038878136e7cb441d36273c9bd415687453ae5e76b785e048bead40aeb13"))
	    (10, uint256("0x0000054555b289c32a5f16cf7ffda128c391a25f8c5b2a0fc9fffec223e90540"))
		(12, uint256("0x00000780a2e6931bc0e3d884519973c2acdd1a477bef9145a808ae3a3d3c554b"));


static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1553402924, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 43101;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // xtella starting difficulty is 1 / 2^12
        ...
        const char* pszTimestamp = "xtellaCoin, otherwise known as Xtella, is a next-generation cryptocurrency, With SeeSaw Plus Reward System and Proof of Stake";
	...
	txNew.vout[0].scriptPubKey = CScript() << ParseHex("046901033eeb013d794cbbc51a8b6bc5fff90c86bd35d07e3edac2ed065cc738d6bc51ab0214747a0d774fd32c260e01bf8c5d398e981d53cce04785dd20b32d84") << OP_CHECKSIG;
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1553047713;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1587699;

  	hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x10452f6ee15188c8777bd32a03d9cc2be3f03ae133cf8bb5caaf7c95fcab86f6"));
...
"04acfa23dd09e78a17c39ac6a947b016ea750af51c9d9b74eeb2da90c5bd526a271d68820626160ffbe9633e61dda2bdd2c7709a5c4285a1c87bbf2fc8396af498";
        ...
        nStartMasternodePayments = 1517076275; //Saturday, 27 de January de 2019 18:04:35
    }
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // xtella: 1 day
        nTargetSpacing = 1 * 60;  // xtella: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // xtella: 1 day
        nTargetSpacing = 1 * 60;        // xtella: 1 minutes
