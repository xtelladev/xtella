...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* xtella features */
        {"xtella", "masternode", &masternode, true, true, false},
        {"xtella", "masternodelist", &masternodelist, true, true, false},
        {"xtella", "mnbudget", &mnbudget, true, true, false},
        {"xtella", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"xtella", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xtella", "mnsync", &mnsync, true, true, false},
        {"xtella", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"xtella", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xtellad, or the -server option to xtella-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> xtella-cli " + methodname + " " + args + "\n";
}
