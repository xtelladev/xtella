/* src/config/xtella-config.h.  Generated from xtella-config.h.in by configure.  */
/* src/config/xtella-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.xtellacoin.info"

/* Define to the full name of this package. */
#define PACKAGE_NAME "xtella Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "xtella Core 2.4.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xtella"
