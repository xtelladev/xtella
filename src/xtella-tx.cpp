...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("xtella Core xtella-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xtella-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xtella transaction") + "\n" +
                               "  xtella-tx [options] -create [commands]   " + _("Create hex-encoded xtella transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xtella transaction
