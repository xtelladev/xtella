...
/** Utility functions used by the xtella Qt UI.
 */
namespace GUIUtil
{
...
// Render xtella addresses in monospace font
...
// Parse "xtella:" URI into recipient object, return true on successful parsing
