                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("xtella Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a xtella address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xtella: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About xtella Core"), this);
    aboutAction->setStatusTip(tr("Show information about xtella Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for xtella"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your xtella addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified xtella addresses"));
    ...
    openAction->setStatusTip(tr("Open a xtella: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the xtella Core help message to get a list with possible xtella command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("xtella Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to xtella network", "", count));
}
...
{
    QString strTitle = tr("xtella Core"); // default title
